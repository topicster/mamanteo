...
sp1 = subplot(2,2,1);
hold on
bH = bar(mean(SENAMHI_HMT_PP_19902018_Hmon),'facecolor',0.8*[1 1 1],'DisplayName','Highlands'' precipitation (1990-2018)');
boxplot(SENAMHI_HMT_PP_19902018_Hmon,'PlotStyle','compact','colors',0*[1 1 1],'Labels',MonthLabels)
dH = plot(SENAMHI_HMT_PP_DThrmon_19902018([refmon_hy:12,1:refmon_hy-1]),'-r','Linewidth',1,'DisplayName','Highlands'' precipitation drought threshold');
% Plot settings
...
% Thresholds
dH = plot([refyrs_hy(1) refyrs_hy(2)+1],[1 1]*SENAMHI_HMT_PP_DThryr_19902018(2),'-r','Linewidth',1,'DisplayName','Highlands'' drought threshold');
dL = plot([refyrs_hy(1) refyrs_hy(2)+1],[1 1]*SENAMHI_CHO_PP_DThryr_19902018(2),'--r','Linewidth',1,'DisplayName','Lowlands'' drought threshold');
...
d = plot([refyrs_hy(1) refyrs_hy(2)+1],[1 1]*userinput_frl*ANA_CHO_HQ_DThryr_19902018(2),':r','Linewidth',2,'DisplayName','Altered Rimac river flow drought threshold');
% Plot settings
...
% Fix location
sp1.Position(1) = sp2.Position(1);
% Fix width
sp1.Position(3) = sp2.Position(3);
% Fix height
sp1.Position(4) = sp2.Position(4);

% Clear auxiliar variables
clear fig_S1 fig_1 offset_loc refmon_hy refyrs_hy sp1 sp2
...
% Initialise variables
offset_loc = [-0.1 0.1 0.05]; % To locate plot texts and scale axis
...
text(offset_loc(1),1+offset_loc(2)/4,'d','Units','normalized','FontWeight','bold','FontSize',16)
% Legend
