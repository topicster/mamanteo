...
plot(datetime(iMHEA_HMT_Tracers_Int_1day(:,1),'ConvertFrom','datenum'),...
    ...
    '--','LineWidth',1,'color',[0 0.5 0],...
    'DisplayName','Fractional residence time')
% Plot settings
...
plot(refhydt,iMHEA_HMT_01_MAMFLOW_Hmon(:,3),'Linewidth',2,'color',[0 0.5 0],'DisplayName','Potential effect of mamanteo');
% Plot settings
b(1).FaceColor = 'none';
...
plot(refhydt,iMHEA_HMT_02_MAMFLOW_Hmon(:,3),'Linewidth',2,'color',[0 0.5 0],'DisplayName','Potential effect of mamanteo');
% Plot settings
b(1).FaceColor = 'none';
b(1).EdgeColor = 0.5*[1 1 1];
...
% Clear auxiliar variables
clear fig_S7 offset_loc refhyv refhydt refmon_hy refyrs lim1 lim2
