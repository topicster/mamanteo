...
plot(iMHEA_HMT_Tracers_Int_1day(:,1)-iMHEA_HMT_Tracers_Avg(1,1),...
    ...
    'DisplayName','Residence time interpolated at daily scale')
plot(iMHEA_HMT_Tracers_Int_1day(:,1)-iMHEA_HMT_Tracers_Avg(1,1),...
...
b = plot(datetime(iMHEA_HMT_Tracers_Int_1day(:,1),'ConvertFrom','datenum'),...
    ...
    '-','LineWidth',1,'color',[0.85 0.33 0.01],...
    'DisplayName','Interpolation at daily resolution');
% Plot settings
...
plot(refhydt,iMHEA_HMT_01_MAMFLOW_Hmon(:,2),'Linewidth',1,'Color',[0 0.45 0.74],'DisplayName','Original C1 discharge');
plot(refhydt,iMHEA_HMT_01_MAMFLOW_Hmon(:,3),'Linewidth',1,'color',[0 0.5 0],'DisplayName','Potential effect of mamanteo');
% Plot settings
...
subplot(1,2,2)
hold on
plot(refhydt,iMHEA_HMT_02_MAMFLOW_Hmon(:,1),'Linewidth',1,'Color',0.5*[1 1 1],'DisplayName','Catchment C2 rainfall');
plot(refhydt,iMHEA_HMT_02_MAMFLOW_Hmon(:,2),'Linewidth',1,'Color',[0 0.45 0.74],'DisplayName','Original C2 discharge');
plot(refhydt,iMHEA_HMT_02_MAMFLOW_Hmon(:,3),'Linewidth',1,'color',[0 0.5 0],'DisplayName','Potential effect of mamanteo');
% Plot settings
set(gca,'Ylim',[-offset_loc(3) 1+offset_loc(3)]*lim1,...
    'YGrid','on',...
    'TickDir','out')
...
% Clear auxiliar variables
clear fig_S5 refhyv refhydt offset_loc lim1 i
...
disp('Exporting the Figure to pdf')
% Set the paper size [width height]
set(fig_S6,'PaperSize',[30 30]);
% set(fig_S6,'PaperOrientation','landscape')
print(fig_S6,'FigS6_export','-dpdf','-fillpage')

% Clear auxiliar variables
clear fig_S6 offset_loc refhyv refhydt refmon_hy refyrs lim1 lim2
...
disp('Done')
disp(' ')
%% 18. Sensitivity analysis for the recovery rate
disp('18. Sensitivity analysis for the recovery rate')
...
for j = 1:length(userinput_frs)
    ...
    % Monthly modified hydrograph
    [~,ANA_CHO_SA_19612018_1yr{j},~,~,ANA_CHO_SA_19612018_Mmon{j}] = iMHEA_MonthlyRain(ANA_CHO_HQ_19612018_date,ANA_CHO_SA_19612018_1day(:,j));
    % Reorganise in hydrological years
...
disp(' ')
%% 19. Save results
disp('19. Saving results from the analysis')
